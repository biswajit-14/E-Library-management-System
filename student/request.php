  ...
  <span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; open</span>
	...
	<?php
	  ...
	  $q=mysqli_query($db,"SELECT * from issue_book where username='$_SESSION[login_user]' and approve='' ;");
		...
		?>
		<p align="center"><button type="submit" name="delete" class="btn btn-success" onclick=
		"location.reload()">Delete</button></p>
  ...
  if(isset($_POST['delete']))
  {
	  if(isset($_POST['check']))
	  {
		  foreach ($_POST['check'] as $delete_id)
		  {
			  ...
			  mysqli_query($db,"DELETE from issue_book WHERE bid='$delete_id' and 
			  username='$_SESSION[login_user]' ORDER BY bid ASC LIMIT 1 ;");
		  }
	 }
  }
?>
